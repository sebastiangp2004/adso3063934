...
export default function DeleteConsoleModal({ consoleId, consoleName }: DeleteConsoleModalProps) {
                        ...
                        <div className="relative z-10 w-full max-w-md bg-base-200 border border-white/[0.08] rounded-2xl shadow-2xl">
                            ...
                            <div className="flex items-center justify-between px-6 py-4 border-b border-white/[0.06]">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h2 className="text-base font-bold text-white tracking-tight">Delete Console</h2>
                            ...
                            <div className="px-6 py-5 space-y-4">
                                <p className="text-sm text-white/60 leading-relaxed">
                                    ...
                                    <span className="text-white font-semibold">"{consoleName}"</span>?
                                    {" "}This will permanently remove the console from the database.
                                </p>
                                ...
                                <div className="flex items-start gap-2 px-4 py-3 bg-warning/10 border border-warning/20 rounded-lg">
                                    ...
                                    <p className="text-[11px] font-mono text-warning/80 leading-relaxed">
                                        Deletion will fail if this console has games associated with it. Remove the games first.
                                    </p>
                                </div>
