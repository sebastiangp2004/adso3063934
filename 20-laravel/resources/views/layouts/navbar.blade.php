<div class="navbar bg-[#fffa] shadow-sm fixed top-0 z-2">
    <div class="navbar-start">
        <div class="dropdown">
            ...
            <ul tabindex="-1" class="menu menu-md dropdown-content bg-[#fffa] rounded-box z-1 mt-3 w-52 p-2 shadow">
                <li>
                ...
                <li>
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                        <a href="{{ route('logout') }}" class="flex gap-2 justify-center items-center" onclick="event.preventDefault();
